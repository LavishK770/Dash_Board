import { FETCH_FAILED_TICKETS, FETCH_REQUIST_TICKETS, FETCH_SUCCESS_TICKETS ,FETCH_SUCCESS_ALL, FETCH_ORDER,} from "./Rtype"
...
const Rreducer=(state=initialState,action)=>{
 switch(action.type){
